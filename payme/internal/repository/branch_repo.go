...
func (r *pgBranchRepository) Create(ctx context.Context, b *models.Branch) (*models.Branch, error) {
	// topic_id qo'shildi
	query := `INSERT INTO branches (name, monthly_fee, mfo_code, account_number, merchant_id, topic_id)
			  VALUES ($1, $2, $3, $4, $5, $6) RETURNING id, created_at`
	
	err := r.db.QueryRow(ctx, query, b.Name, b.MonthlyFee, b.MfoCode, b.AccountNumber, b.MerchantID, b.TopicID).Scan(&b.ID, &b.CreatedAt)
	if err != nil {
...
func (r *pgBranchRepository) GetByID(ctx context.Context, id uuid.UUID) (*models.Branch, error) {
	// topic_id qo'shildi
	query := `SELECT id, name, monthly_fee, mfo_code, account_number, merchant_id, topic_id, created_at FROM branches WHERE id = $1`
	
	var b models.Branch
	err := r.db.QueryRow(ctx, query, id).Scan(&b.ID, &b.Name, &b.MonthlyFee, &b.MfoCode, &b.AccountNumber, &b.MerchantID, &b.TopicID, &b.CreatedAt)
	if err != nil {
...
func (r *pgBranchRepository) GetAll(ctx context.Context) ([]models.Branch, error) {
	// topic_id qo'shildi
	query := `SELECT id, name, monthly_fee, mfo_code, account_number, merchant_id, topic_id, created_at FROM branches`
	...
	for rows.Next() {
		var b models.Branch
		// Scan ga &b.TopicID qo'shildi
		err := rows.Scan(&b.ID, &b.Name, &b.MonthlyFee, &b.MfoCode, &b.AccountNumber, &b.MerchantID, &b.TopicID, &b.CreatedAt)
		if err != nil {
...
func (r *pgBranchRepository) Update(ctx context.Context, b *models.Branch) (*models.Branch, error) {
	// topic_id qo'shildi
	query := `UPDATE branches SET name = $1, monthly_fee = $2, mfo_code = $3, account_number = $4, merchant_id = $5, topic_id = $6
			  WHERE id = $7 RETURNING id, name, monthly_fee, mfo_code, account_number, merchant_id, topic_id, created_at`
	
	err := r.db.QueryRow(ctx, query, b.Name, b.MonthlyFee, b.MfoCode, b.AccountNumber, b.MerchantID, b.TopicID, b.ID).Scan(
		&b.ID, &b.Name, &b.MonthlyFee, &b.MfoCode, &b.AccountNumber, &b.MerchantID, &b.TopicID, &b.CreatedAt)
	if err != nil {
